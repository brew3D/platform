  ...
  return (
    <>
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        style={{ position: 'fixed', right: 20, bottom: 20, width: 56, height: 56, borderRadius: 999, background: 'radial-gradient(circle at 30% 30%, #6d28d9, #a855f7)', boxShadow: '0 12px 30px rgba(124,58,237,0.5)', animation: 'orbPulse 3s ease-in-out infinite', zIndex: 80 }}
      />
