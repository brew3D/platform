        ...
        <div className={`${styles.projectsContainer} ${viewMode === 'list' ? styles.listView : styles.gridView}`}>
          {sortedProjects.map((project) => (
            ...
            <div className={styles.projectThumbnail}>
              { (project?.settings?.coverImageUrl || project.coverImageUrl || project.coverImage || project.cover) ? (
                <img
                  src={project?.settings?.coverImageUrl || project.coverImageUrl || project.coverImage || project.cover}
