        ...
        <div className={styles.content}>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.sectionContent}>
              <p>By accessing and using Brew3D&apos;s services, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.</p>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.sectionContent}>
              <p>Brew3D provides a cloud-based, AI-powered 3D modeling and collaboration platform that includes:</p>
              <ul>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.sectionContent}>
              ...
              <ul>
                ...
                <li>Use the service to compete with Brew3D</li>
              </ul>
            </div>
          </section>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.sectionContent}>
              <p>To the maximum extent permitted by law, Brew3D shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or use, arising from your use of our service.</p>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.sectionContent}>
              <p>You agree to indemnify and hold harmless Brew3D, its officers, directors, employees, and agents from any claims, damages, or expenses arising from:</p>
              <ul>
