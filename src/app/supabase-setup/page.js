...
import styles from './supabase-setup.module.css';
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <p>Complete SQL instructions to replicate the DynamoDB structure on Supabase</p>
      </div>
      ...
      <div className={styles.section}>
        ...
        <p>Make sure you have these in your <code>.env.local</code>:</p>
        <div className={styles.envVars}>
          <code>SUPABASE_URL=your_supabase_url</code>
          <code>SUPABASE_ANON=your_supabase_anon_key</code>
        </div>
      </div>
      ...
      <div className={styles.section}>
        <div className={styles.sqlHeader}>
          ...
          <button
            ...
            onClick={() => copyToClipboard(sqlContent, 'full')}
          >
      ...
      <div className={styles.section}>
        ...
        <ul className={styles.features}>
          <li><strong>20+ Tables:</strong> Users, Projects, Scenes, Maps, Characters, Assets, Tutorials, Community Posts, Events, RSVPs, Badges, User Badges, User Points, Leaderboards, Chats, Messages, Teams, Presence, Logs, Highlights, Webhooks</li>
          <li><strong>Indexes:</strong> Optimized indexes for all common queries</li>
          <li><strong>Triggers:</strong> Automatic timestamp updates and event attendee counting</li>
          <li><strong>RLS Policies:</strong> Basic Row Level Security policies (customize as needed)</li>
          <li><strong>Foreign Keys:</strong> Proper referential integrity</li>
        </ul>
      </div>
      ...
      <div className={styles.section}>
        ...
        <ul className={styles.notes}>
          <li>This migration is idempotent - you can run it multiple times safely</li>
          <li>Row Level Security (RLS) is enabled but you may need to customize policies for your use case</li>
          <li>All JSONB fields preserve the same structure as DynamoDB</li>
          <li>Timestamps use PostgreSQL TIMESTAMPTZ for timezone support</li>
          <li>Arrays use PostgreSQL TEXT[] for better performance</li>
        </ul>
      </div>
    </div>
  );
